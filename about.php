...
<div class="row">
   ...
   <div class="clear"></div>
   	<div class="head_box left">
   		<div class="col_2 col"><div class="logo align_center">&nbsp;</div></div>
			<div class="col_12 col">
				<h1>Perpustakaan Digital E-lib</h1>
      
      
      <h4>Tentang Aplikasi Ini</h4>
      <br><p style="font-size:14px;">
      	Aplikasi ini di buat bertujuan untuk memudahkan mahasiswa dalam mencari bahan/materi perkuliahan. 
			Selamat Menikmati.
			
		<h4>Credit</h4>
			Programming - Muh. Fadilah, Muh. Akbar Yasin.
<br><br>
			<h4>Support</h4>

 			<a href="http://genetika.kendari.linux.org">genetika.kendari.linux.org</a>
			<br>Contact new.camp.web@gmail.com
      </p>
			</div>
