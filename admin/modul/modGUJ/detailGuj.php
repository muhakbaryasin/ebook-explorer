...
//session_start();
	if (empty($_SESSION['namauser']) AND empty($_SESSION['passuser'])){
		...
		$tampil = mysql_query("SELECT * FROM ujian,mata_pelajaran,kelas 
										...
										AND mata_pelajaran.id_mapel=ujian.id_mapel 
		...
		echo "<table>
				  ...
				  <tr>
					  <th height=25>Ujian Yang Telah Dikumpul</th>
					  <td><a href='media.php?module=guj&act=detailKumpul&id=$r[id_ujian]' class='button orange'>Lihat Berkas</a></td>
				  </tr>
				  <tr>
